...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./grpo_gsm8k_model", help="Directory to save the trained model")
    ...
    parser.add_argument("--beta_grpo", type=float, default=0.1, help="Beta for GRPO")
